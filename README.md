...
- **Ứng dụng**: Linux là nền tảng cho máy chủ web, hệ thống đám mây, Android, và các pipeline DevOps/Data Engineering.
...
### 6.1. Cài đặt Ubuntu
- **Chuẩn bị**:
  - Tải file ISO Ubuntu 22.04 LTS từ trang chính thức: [ubuntu.com](https://ubuntu.com).
  - Sử dụng công cụ như Rufus (Windows) hoặc `dd` (Linux) để tạo USB boot.
  - Yêu cầu phần cứng tối thiểu: 2GB RAM, 20GB ổ cứng.
- **Quy trình cài đặt**:
  1. Cắm USB, khởi động máy, vào BIOS để chọn boot từ USB.
  2. Chọn "Install Ubuntu" từ menu GRUB.
  3. Làm theo hướng dẫn: chọn ngôn ngữ, múi giờ, phân vùng ổ cứng (tự động hoặc thủ công), tạo user/password.
  4. Sau khi cài đặt xong, khởi động lại máy và đăng nhập.
- **Kết quả**: Hệ thống Ubuntu 22.04 được cài đặt thành công trên máy ảo VirtualBox.

### 6.2. Kiểm tra các câu lệnh cơ bản
Sau khi cài đặt, tôi đã thực hành một số câu lệnh Linux cơ bản để kiểm tra hệ thống:
...
Sao chép
df -h
Kết quả: Dung lượng đã dùng/còn trống, ví dụ /dev/sda1 20G 5.2G 14G 27% /.
Cập nhật hệ thống:
bash
